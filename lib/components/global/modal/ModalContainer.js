...
const ModalContainer = React.createClass({
	 ...
	 * @memberOf GlobalComponents.ModalContainer
	 *
	 * @return {object | boolean} Width of modal in pixels or false if one is not provided
	 */
	_modalWidth: function() {
		...
		try {
			...
			console.warn(`A digit is required when specifying width.  Your input: "${width}".  Falling back to 600px.`);
			return false;
		}
	},
