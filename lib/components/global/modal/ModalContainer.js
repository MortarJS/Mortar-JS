...
const ModalContainer = React.createClass({
	...
	_shouldRenderOverlay: function () {
		return this.state.isOpen && <div className="modal-backdrop fade in"></div>;
	},
	...
	_modalBodyClasses: function() {
		return this.props.modalBodyClasses ? 'modal-body ' + this.props.modalBodyClasses : 'modal-body';
	},
	 ...
	 * @memberOf GlobalComponents.ModalContainer
	 *
	 * @return {object} [width of modal in pixels]
	 */
	...
	_renderModal: function() {
		return (
			<div>
				<div className={this._modalClassnames()} tabIndex="-1" role="dialog" style={{display: 'block'}} onClick={this.handleClick}>
					<div className="modal-dialog" ref="dialog" style={this._modalWidth()}>
