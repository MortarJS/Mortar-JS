	...
	multipleFilePreview: function() {
		if (this.state.fieldValue &&
			this.state.fieldValue.length) {
				...
				return (
					<section id="mortar-file-upload-preview-container">
						{images.map((img, i) => {
							let source = img.preview ? img.preview : img;
							...
							return (
								<div key={i} className="mortar-file-upload-preview-wrapper">
									...
									<img className="mortar-file-upload mortar-file-upload-preview" src={source} width={width} height={height} />
								</div>
							);
						})}
					</section>
			...
			return (
				<div className="upload-file-container">
					<div className={classes} onDragLeave={this.handleDragLeave}
						 onDragOver={this.handleDragOver} onDrop={this.handleUpload}>
