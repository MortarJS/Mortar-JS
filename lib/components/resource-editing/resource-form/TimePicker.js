...
var TimePicker = React.createClass({
	...
	handleInput: function(resource, event) {
		let value         = event.target.value,
			...
			newTime       = oldTime.add(1, resource).format(this.props.format);
	...
	handleTimeChange: function(action, resource) {
		...
		this.setState({
			...
			console.log('poop', this.state.fieldValue, this.state.resource, this.state.time)
		});
