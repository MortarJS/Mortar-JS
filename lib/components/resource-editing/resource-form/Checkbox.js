 ...
 *
 * @class Checkbox
 * @property {string}   fieldKey       The key for the property on the object getting edited.
 * @property {function} changeCallback The function that is called whenever a change occurs to this component
 * @property {array}    options        The options that will turn into checkboxes
 * @property {string}   labelAttribute The attribute on an object to be displayed
 * @property {boolean}  disabled       If true, disables making changes to the component
 * @property {array}    comparisonAttr The attribute to compare to the form's bound resource and return
 * @property {string}   overrideclass  A string of classes to attach to the rendered checkboxes
 *
