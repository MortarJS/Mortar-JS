 ...
 * @example
 * <Fz.Form.DropdownSelect fieldKey='Ages'
	...
	displaySelected: function() {
		...
		if (typeof selected === 'object') {
				...
				if (typeof option === 'object') {
					...
					return (
						<div className={'selected-option'}>
							{displayLabel}
							<a href="javascript:void(0)" className={'fa fa-times'} onClick={this.handleAction.bind(null, 'remove', index)} />
						</div>
					)
				} else {
					return (
			...
			return (
					<div className={'selected-option'}>
						{selected}
						<a href="javascript:void(0)" className={'fa fa-times'} onClick={this.handleAction.bind(null, 'remove', -1)} />
					</div>
			)
		}
	},
