 ...
 * @type {ReactComponent}
 *
 * @property {!object} data     The data to display for this row.
 * @property {!object} dataKeys The data keys to display from data.  Each key maps to a single cell.
 * @property {!array}  rows     All the rows for the table.
 * @property {object=} options  Additional options to configure that data.
 *
