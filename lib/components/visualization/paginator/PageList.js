			...
			<div className="dataTables_paginate paging_simple_numbers" id="dataTables-example_paginate">
				<ul className="pagination">
					<li className={previousClasses} tabIndex="0" id="dataTables-example_previous">
						<a href="#" onClick={this.firstPage} className="fa fa-angle-double-left" ></a>
					</li>

					<li className={previousClasses} tabIndex="0" id="dataTables-example_previous">
						<a href="#" onClick={this.previousPage} className="fa fa-chevron-left" ></a>
					</li>

					{this.buildPageList()}

					<li className={nextClasses} tabIndex="0" id="dataTables-example_next">
						<a href="#" onClick={this.nextPage} className="fa fa-chevron-right"></a>
					</li>

					<li className={nextClasses} tabIndex="0" id="dataTables-example_next">
						<a href="#" onClick={this.lastPage} className="fa fa-angle-double-right"></a>
					</li>
				</ul>
			</div>
		)
